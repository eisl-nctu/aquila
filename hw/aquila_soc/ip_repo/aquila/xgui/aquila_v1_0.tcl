...
proc init_gui { IPINST } {
  ...
  set C_M_DMEM_PORT_ID_WIDTH [ipgui::add_param $IPINST -name "C_M_DMEM_PORT_ID_WIDTH" -parent ${Page_0}]
  set_property tooltip {Thread ID Width} ${C_M_DMEM_PORT_ID_WIDTH}
  set C_M_DMEM_PORT_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M_DMEM_PORT_ADDR_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of Address Bus} ${C_M_DMEM_PORT_ADDR_WIDTH}
  set C_M_DMEM_PORT_DATA_WIDTH [ipgui::add_param $IPINST -name "C_M_DMEM_PORT_DATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of Data Bus} ${C_M_DMEM_PORT_DATA_WIDTH}
