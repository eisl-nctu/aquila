/*
   This file was adopted from the FreeRTOS project, with minimal
   modifications to provide malloc() and free() functions for the
   BSP library of Aquila processor.

   By Chun-Jen Tsai on Dec/13/2019.
*/
...
#define MPU_WRAPPERS_INCLUDED_FROM_API_FILE
    ...
    #define configTOTAL_HEAP_SIZE			( ( size_t ) ( 0x20000000 ) )
