...
ee_u16 core_bench_list(core_results *res, ee_s16 finder_idx)
{
    ...
    info.data16 = 0; /* added to remove a warning. */
    info.idx = finder_idx;
...
list_head *core_list_init(ee_u32 blksize, list_head *memblock, ee_s16 seed)
{
    ...
    ee_u32 size = (blksize / per_item) - 2; /* to accomodate systems with 64b pointers,
                                               and make sure same code is executed,
                                               set max list elements */
